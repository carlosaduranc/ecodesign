...
\subsubsection*{Use Case}
In contrast to the analog alternative previously described, the energy required to use the digital components has to be accounted for. The energy required for the iPad and Apple Pencil was taken as whole in \textsc{SimaPro}, since the Apple Pencil is charged with the iPad. The selected scenario in \textsc{SimaPro} is inspired from the use of a laptop, which takes into account a total charge each day for 240 days a year. Considering the energy capacity for an iPad's battery of 29Wh, this equates to a total of 34.8kWh (or 125.8 MJ) over 5 years.
